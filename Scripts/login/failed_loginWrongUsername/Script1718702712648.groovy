...
WebUI.setText(findTestObject('login/username_field', [('variable') : 'idcbr.sitih']), 'idcbr.sitihabc')

WebUI.setText(findTestObject('login/password_field'), 'testing123$')

WebUI.click(findTestObject('login/login_button'))

WebUI.verifyElementText(findTestObject('login/message_loginFailed'), 'The user account or password is incorrect, and have 5 attempts remaining.')
